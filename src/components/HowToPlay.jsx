        ...
        <>
            ...
            <Container className="my-5 px-4">
                ...
                <ol className="how-list">
                    ...
                    <li>Kedua kamu akan diminta untuk memilih berapa huruf yang terdapat di nama yang akan ditebak. Contohnya B-A-K-W-A-N yang terdiri dari 6 huruf. Untuk panjang huruf nama yang bisa ditebak oleh <strong>GuessYourName</strong> itu <i><u>minimal terdiri dari 3 huruf dan maksimal terdiri dari 7 huruf</u>.</i></li>
                    ...
                    <li>Kelima <strong>GuessYourName</strong> akan menampikan hasil tebakannya, sesuai dengan apa yang kamu pilih sebelumnya. <strong>Jadi pastikan kamu pilih yang benar</strong>.</li>
                </ol>
            </Container>
            <Container className="my-5 px-4">
