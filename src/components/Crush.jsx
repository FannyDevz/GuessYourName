...
function Crush() {
    ...
    const stepText = {
        0: "Pilih huruf pertama",
        1: "Pilih huruf kedua",
        2: "Pilih huruf ketiga",
        3: "Pilih huruf keempat",
        4: "Pilih huruf kelima",
        5: "Pilih huruf keenam",
        6: "Pilih huruf ketujuh",
        7: "Pilih huruf kedelapan",
    }
    const lengthText = {
        1: "dari 1 Huruf",
        2: "dari 2 Huruf",
            ...
            <Modal show={infoModal} centered>
                ...
                <Modal.Body>
                    <Container fluid className="information-wrapper">
                        ...
                        <div className="information-child">
                            <p><strong>GuessYourName</strong> tidak akan menyimpan data yang anda masukkan</p>
                        </div>
                    </Container>
                </Modal.Body>
                <Modal.Footer>
                ...
                {display1 &&
                    <div className="main-wrapper">
                        ...
                        <Modal show={show1} onHide={handleClose1} centered>
                            ...
                            <Modal.Body>Kamu diminta untuk memilih berapa huruf yang terdapat di nama yang akan ditebak. Contohnya B-A-K-W-A-N yang terdiri dari 6 huruf. Untuk panjang huruf nama yang bisa ditebak oleh <strong>GuessYourName</strong> itu <i><u>minimal terdiri dari 3 huruf dan maksimal terdiri dari 7 huruf</u>.</i></Modal.Body>
                            <Modal.Footer>
                    ...
                    {length === "3" && 
                        <div className="my-5 py-5 text-center">
                            ...
                            <div>
                                ...
                                <p className="main-of mt-4">{(stepText[step])} {(lengthText[length])} </p>
                                {step === 3 ?
            ...
            {choose.length === 9 &&
                <div className="my-5 py-5 text-center">
                    ...
                    <div>
                        ...
                        <p className="main-of mt-4">{(stepText[step2])} {(lengthText[length])}</p>
                        {step2 === 3 ?
